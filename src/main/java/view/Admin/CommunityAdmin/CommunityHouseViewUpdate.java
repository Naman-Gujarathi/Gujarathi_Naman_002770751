...
public class CommunityHouseViewUpdate extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblAddressLine1.setFont(new java.awt.Font("Lava Kannada", 1, 12)); // NOI18N
        lblAddressLine1.setForeground(new java.awt.Color(204, 204, 204));
        ...
        lblHouseRecord.setFont(new java.awt.Font("Lava Kannada", 1, 12)); // NOI18N
        lblHouseRecord.setForeground(new java.awt.Color(204, 204, 204));
        lblHouseRecord.setText("House Record");

        lblAddressLine2.setBackground(new java.awt.Color(204, 204, 0));
        lblAddressLine2.setFont(new java.awt.Font("Lava Kannada", 1, 12)); // NOI18N
        lblAddressLine2.setForeground(new java.awt.Color(204, 204, 204));
